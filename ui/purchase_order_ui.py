"""
UI building methods for Purchase Order widget.
Mirrors Purchase Entry layout with PO-specific footer (status, no payment fields).
"""
...
class PurchaseOrderUIMixin:
    """Mixin class containing all UI building and styling methods for Purchase Order."""
    ...
    def build_page_header_strip(self):
        ...
        title_label = QLabel("PURCHASE ORDER")
    ...
    def build_bill_options_strip(self):
        ...
        self.code_display.setStyleSheet(theme.entry_footer_value_label_style("input_text"))
    ...
    def build_lower_control_panel(self):
        ...
        self.final_amount_display.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
    ...
    def footer_value_style(self):
        return theme.entry_footer_value_label_style("input_text")

    def footer_final_style(self):
        return theme.entry_info_value_style()

    def footer_final_display_style(self):
