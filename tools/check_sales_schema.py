"""Diagnostic: print the column layout of the sales table.
...
def main():
    """Connect to the shared database and list sales table columns."""
    ...
    try:
        ...
        print(f"Database error while reading sales schema: {exc}")
    finally:
